...
from FinMind.strategies.institutional_investors_follower import InstitutionalInvestorsFollower
...
from FinMind.strategies.short_sale_margin_purchase_ratio import ShortSaleMarginPurchaseRatio
